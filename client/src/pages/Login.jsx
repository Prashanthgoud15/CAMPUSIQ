...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-gpcet-bg flex flex-col md:flex-row text-gpcet-text font-sans">
      ...
      <div className="md:w-2/5 p-8 flex flex-col justify-center bg-[#0A0F1E] border-r border-gpcet-border relative overflow-hidden hidden md:flex">
        ...
        <div className="relative z-10 max-w-md mx-auto">
          ...
          <div className="flex flex-wrap gap-2 mb-8">
            <span className="px-3 py-1 rounded-full bg-[#111827] border border-gpcet-border text-xs font-medium">
              JNTUA Autonomous
            </span>
            <span className="px-3 py-1 rounded-full bg-[#111827] border border-gpcet-border text-xs font-medium">
              NAAC A Grade
      ...
      <div className="w-full md:w-3/5 flex items-center justify-center p-6 sm:p-8 bg-gpcet-bg">
        <div className="w-full max-w-md bg-gpcet-card p-8 rounded-2xl border border-gpcet-border shadow-2xl relative overflow-hidden">
            ...
            <div>
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  className="w-full bg-[#0A0F1E] border border-gpcet-border rounded-xl py-3.5 pl-12 pr-4 text-white placeholder-gray-600 focus:ring-2 focus:ring-gpcet-primary outline-none transition-all text-base sm:text-sm"
                />
              </div>
            </div>
          ...
          <div className="mt-8 pt-6 border-t border-gpcet-border">
            <h4 className="text-xs uppercase text-gpcet-muted font-bold tracking-wider mb-3 text-center">Demo Credentials</h4>
            <div className="bg-[#0A0F1E] rounded-lg p-3 text-xs text-gpcet-muted space-y-2 font-mono border border-gpcet-border/50">
              <div className="flex justify-between items-center">
                <span className="bg-[#111827] px-2 py-0.5 rounded text-[10px] uppercase font-bold text-gpcet-primary">Student</span>
              ...
              <div className="flex justify-between items-center pt-1 border-t border-gpcet-border/50">
                <span className="bg-[#111827] px-2 py-0.5 rounded text-[10px] uppercase font-bold text-gpcet-accent">Admin</span>
