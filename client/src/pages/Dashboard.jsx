...
const Dashboard = () => {
    ...
    return (
      <div className="max-w-7xl mx-auto pb-12 p-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
           <div className="h-[180px] bg-[#111827] rounded-3xl animate-pulse border border-white/5"></div>
           <div className="h-[180px] bg-[#111827] rounded-3xl animate-pulse border border-white/5"></div>
           <div className="h-[180px] bg-[#111827] rounded-3xl animate-pulse border border-white/5"></div>
        </div>
  ...
  return (
    <div className="max-w-7xl mx-auto pb-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
        <div className="bg-[#111827] rounded-3xl p-6 border border-gpcet-border shadow-lg relative overflow-hidden group hover:border-gpcet-primary/30 transition-colors">
          ...
          <div className="relative z-10">
            ...
            <h3 className="text-4xl font-black text-white tracking-tight mb-2">{totalSubjectsCount}</h3>
            <p className="text-[10px] uppercase tracking-wider text-blue-400/80 font-bold bg-[#0A0F1E] inline-block px-3 py-1 rounded-full border border-gpcet-border shadow-inner">R23 &bull; {user.branch} &bull; Y{user.year}S{user.semester}</p>
          </div>
        </div>

        <div className="bg-[#111827] rounded-3xl p-6 border border-gpcet-border shadow-lg relative overflow-hidden group hover:border-gpcet-nptel/30 transition-colors">
          <div className="absolute top-0 right-0 p-6 opacity-5 group-hover:opacity-10 transition-opacity group-hover:scale-110 duration-500">
          ...
          <div className="relative z-10">
            ...
            <h3 className="text-4xl font-black text-white tracking-tight mb-2">{nptelCount}</h3>
            <p className="text-[10px] uppercase tracking-wider text-green-400/80 font-bold bg-[#0A0F1E] inline-block px-3 py-1 rounded-full border border-gpcet-border shadow-inner">Active this semester</p>
          </div>
        </div>

        <div 
          onClick={() => navigate('/meera')}
          className="bg-gradient-to-br from-[#1E1B4B] to-[#111827] cursor-pointer rounded-3xl p-6 border border-gpcet-accent/30 shadow-lg relative overflow-hidden group hover:border-gpcet-accent/60 transition-all hover:shadow-[0_0_30px_rgba(139,92,246,0.15)] hover:-translate-y-1"
        >
          ...
          <div className="relative z-10">
            ...
            <h3 className="text-4xl font-black text-white tracking-tight mb-2">AI Ready</h3>
            <p className="text-[10px] uppercase tracking-wider text-gpcet-accent/80 font-bold bg-[#0A0F1E] inline-block px-3 py-1 rounded-full border border-gpcet-border shadow-inner">Groq llama3-70b &bull; Streaming</p>
          </div>
        </div>
      </div>

      <div className="mb-6 flex items-center justify-between">
        <h2 className="text-xl font-bold text-white">Your Subjects This Semester</h2>
        <div className="h-px bg-gpcet-border flex-1 ml-6"></div>
      </div>

      {totalSubjectsCount === 0 ? (
        <div className="text-center py-16 bg-[#111827] rounded-3xl border border-dashed border-gpcet-border shadow-inner">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
          {allSubjectsList.map(subject => (
            <SubjectCard key={subject._id || subject.subject_code} subject={subject} />
          ))}
        </div>
      )}
    </div>
