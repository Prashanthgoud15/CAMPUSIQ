...
const seedData = async () => {
  try {
    ...
    const subjects = [
      ...
      { branch: 'CSE', year: 3, semester: 2, regulation: 'R23', code:'NPTEL3201', name:'Mobile Computing and Ad-Hoc Networks', type:'nptel', credits:3, order:4, nptel_course_url:'https://nptel.ac.in/courses/106105160', nptel_weeks_total:12 },
      { branch: 'CSE', year: 3, semester: 2, regulation: 'R23', code:'NPTEL3202', name:'Cloud Computing', type:'nptel', credits:3, order:5, nptel_course_url:'https://nptel.ac.in/courses/106105215', nptel_weeks_total:12 },
      { branch: 'CSE', year: 3, semester: 2, regulation: 'R23', code:'NPTEL3203', name:'Non-Conventional Energy Resources', type:'nptel', credits:3, order:6, nptel_course_url:'https://nptel.ac.in/courses/103104078', nptel_weeks_total:12 },
